      ...
      <div className="flex flex-wrap items-center justify-between mx-auto py-2 px-4">
        <Link href="/" className="flex items-center">
          <img
            ...
            alt="Flowbite Logo"
          />
          <span className="self-center text-4xl font-semibold whitespace-nowrap text-dark dark:text-white">
            <h2>Logo</h2>
          </span>
        </Link>
        <div className="flex items-center md:order-2  ">
          <button
            type="button"
            className="flex  text-sm bg-gray-800  rounded-full md:mr-3 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            id="user-menu-button"
            aria-expanded="false"
